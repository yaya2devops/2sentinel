...
You can continue looking through the [custom workbooks](assets/workbooks/MyCustomReports/README.md) I created and start using them right away.
...
<img src="assets/workbooks/Results/AzureActivity2.png"  >

<br>

<img src="assets/workbooks/Results/AzureActivity3.png"  >
...
<img src="assets/workbooks/Results/MFA4.png"  >

## Conditionnal Access Insights
<img src="assets/workbooks/Results/CA.png"  >


This is a very small portion of the data generated by the product, i hope it helps, due to the confidentiality of the information.

# Product Shutdown
The product can be very expensive; 

We ended up spending $1200 CAD per month to cover the compute required to keep ingesting data and delivering **value**. 

As a result, you may consider shutting it down at some point. 

This section is specifically designed for that purpose.
...
**1-** From Sentinel, go down to **Settings** on the left pane.<br>
**2-** Beside pricing, Click **Settings**.<br>
**3-** Last option, click Remove Microsoft Sentinel.
<img src="assets/shutdown/10-delete(optional).png"  >

<br>

- Confirm **Remove Microsoft Sentinel from your workspace.**
<img src="assets/shutdown/11-deletionsentinel.png"  >

<br>

To make sure, you cut with all expenses.
- Go back to your workspace and **delete** it.
...
## Closure
That's it; your connectors and analytics should now be properly preconfigured. You are capable to add workbooks and create your own. This is a huge accomplishment! By following this technical documentation, you have taken the first step in ensuring that your data is properly managed and monitored. You know also how to delete your product in case its required.
